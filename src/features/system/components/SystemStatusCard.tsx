...
function SystemStatusCard() {
  ...
  if (isLoading) {
    return (
      <section className="rounded-xl border border-border bg-surface p-4 text-slate-300">
  ...
  return (
    <section className="space-y-4 rounded-xl border border-border bg-surface p-4">
      <header>
        <h2 className="text-base font-semibold text-slate-100">Brain Engine</h2>
      ...
      <div className="rounded-lg border border-emerald-900 bg-black p-4 shadow-[0_0_15px_rgba(16,185,129,0.15)]">
        ...
        <button
          ...
          className="mt-3 inline-flex items-center rounded-md border border-emerald-900 bg-surface px-3 py-2 text-sm font-medium text-emerald-300 hover:bg-emerald-950/30"
        >
