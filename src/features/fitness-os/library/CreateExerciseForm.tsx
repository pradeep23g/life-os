    ...
    <form onSubmit={onSubmit} className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
      <label className="block text-sm text-slate-300">
        ...
        <input
          ...
          className="mt-1 w-full rounded-md border border-border bg-[#111111] p-2 text-sm text-slate-100 focus:border-slate-600 focus:outline-none focus:ring-1 focus:ring-slate-600"
        />
      </label>
      <label className="block text-sm text-slate-300">
        Category
      ...
      <button
        ...
        className="rounded-md border border-border bg-[#111111] px-4 py-2 text-sm text-slate-100 transition-colors hover:bg-[#222222] disabled:opacity-60 md:col-span-2"
      >
